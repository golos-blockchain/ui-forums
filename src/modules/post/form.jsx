...
import PostFormFieldRewards from '@/elements/post/form/field/rewards';
import PostFormFieldTags from '@/elements/post/form/field/tags';
import PostFormFieldTitle from '@/elements/post/form/field/title';
...
class PostForm extends React.Component {
    ...
    submit = (e) => {
        ...
        this.props.actions.submit(account, data, realParent || parent, this.props.forum, action, parent);
        this.setState({
            submitting: true
        });
        return false;
                ...
                <div>
                    ...
                    <Segment attached='bottom' padded className={`${activeItem === tt('post_form.tab_post') ? 'active ' : ''}tab`}>
                        ...
                        <PostFormFieldBody
                            ...
                            value={ window.IS_MOBILE ? replyQuote : ((draft.body) ? draft.body : (existingPost) ? existingPost.body : '') }
                        />
                    </Segment>
        ...
        return (
            <div>
                ...
                >
                    ...
                    {window.IS_MOBILE ? null : <Button color={previewEnabled? 'blue' : undefined} floated='right' icon='eye' onClick={this.handlePreview}></Button>}
                    <Button
